...
filename = 'LArPENPlatesPhysDet'#'PENPENPlatesCorrectlyModified'

use_own_MaGe = False #TODO set this to true or false
...
try:
	...
	for i in range(400,801):
		...
		if (detector == 'LGND_200_14String'):
			...
			file.write("/MG/L1000/MakeSiPlatePEN true\n") #TODO select whether SiPlate or PENPlate
		else:
			sys.exit()
		...
		file.write("/MG/eventaction/rootfilename " "LArPENPlatesReflectorPhysDetInterior_%d.root\n"%(i)) 
